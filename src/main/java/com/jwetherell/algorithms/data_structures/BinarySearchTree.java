...
public class BinarySearchTree<T extends Comparable<T>> implements ITree<T> {
     ...
     *
     * @param nodeToRemoved Node<T> to remove from the tree.
     * @return nodeRemove
     ...
     *
     * @param nodeToRemoved   Node<T> to remove replace in the tree. nodeToRemoved should
     *                        NOT be NULL.
     ...
     *
     * @param node Node<T> to validate in the tree. node should NOT be NULL.
    ...
    protected interface INodeCreator<T extends Comparable<T>> {
