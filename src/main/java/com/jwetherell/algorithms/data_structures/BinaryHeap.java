...
public interface BinaryHeap<T extends Comparable<T>> extends IHeap<T> {
     ...
     * @author Justin Wetherell <phishman3579@gmail.com>
     */
    class BinaryHeapArray<T extends Comparable<T>> implements BinaryHeap<T> {
    ...
    class BinaryHeapTree<T extends Comparable<T>> implements BinaryHeap<T> {
    ...
    class JavaCompatibleBinaryHeapArray<T extends Comparable<T>> extends AbstractCollection<T> {
    ...
    class JavaCompatibleBinaryHeapTree<T extends Comparable<T>> extends AbstractCollection<T> {
        ...
        private static class BinaryHeapTreeIterator<C extends Comparable<C>> implements Iterator<C> {
