...
public class RedBlackTree<T extends Comparable<T>> extends BinarySearchTree<T> {
    ...
    protected Node<T> removeNode(Node<T> node) {
        ...
        // Handle one child
        RedBlackNode<T> child = (lesser.id != null) ? lesser : greater;
     ...
     *
     * @param nodeToReplace     will get it's contents replace with nodeToReplaceWith
     *                          contents.
    ...
    public static class JavaCompatibleRedBlackTree<T extends Comparable<T>> extends AbstractCollection<T> {
