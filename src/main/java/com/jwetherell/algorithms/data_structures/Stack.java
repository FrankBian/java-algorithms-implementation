...
public interface Stack<T> extends IStack<T> {
    ...
    class LinkedStack<T> implements Stack<T> {
        ...
        private boolean validate(Node<T> node, java.util.Set<T> keys) {
            ...
            Node<T> child = node.below;
            return !(child != null && !child.above.equals(node));
        }
    ...
    class JavaCompatibleArrayStack<T> extends java.util.AbstractQueue<T> {
    ...
    class JavaCompatibleLinkedStack<T> extends java.util.AbstractQueue<T> {
